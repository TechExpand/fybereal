...
import 'package:fybe/Screen/Admin/RecomendaAdmin/AddRecommened.dart';
...
class RecomnededList extends StatefulWidget {
  const RecomnededList({Key? key}) : super(key: key);

  @override
  _RecomnededListState createState() => _RecomnededListState();
}

class _RecomnededListState extends State<RecomnededList> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('RECOMMENDED FOOD', style: TextStyle(
                              fontSize: 21,
                              color: Colors.white,
          ...
          Builder(
              builder: (context) {
                ...
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Center(child: Text("No Recomended Available", style: TextStyle(
                        color: Colors.black,
                        fontSize: 21,
                        height: 1.4,
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap:(){
                                  print('sss');
                                  var network = Provider.of<WebServices>(context, listen: false);
                                  network.deleteRecomend(menu![index].id).then((value){
                                    setState(() {
                                      calltransaction(context);
                                    });
                                  });
