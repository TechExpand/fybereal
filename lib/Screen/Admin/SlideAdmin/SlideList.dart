...
import 'package:fybe/Screen/Admin/SlideAdmin/AddSlide.dart';
          ...
          Builder(
              builder: (context) {
                ...
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Center(child: Text("No Slide Available", style: TextStyle(
                        color: Colors.black,
                        fontSize: 21,
                        height: 1.4,
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap:(){
                                  print('sss');
                                  var network = Provider.of<WebServices>(context, listen: false);
                                  network.deleteSlide(menu![index].id).then((value){
                                    setState(() {
                                      calltransaction(context);
                                    });
                                  });
